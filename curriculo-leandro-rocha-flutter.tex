...
\begin{tight}
  ...
  \item \lbl{Recursos nativos:} \textbf{integração de SDKs e plugins nativos} (Kotlin/Swift) em apps Flutter para \textbf{Android} e \textbf{iOS} | \textbf{Biometria facial e OCR de documentos (FaceTec)} | \textbf{LiveKit/WebRTC} | CallKit e IncomingCall
