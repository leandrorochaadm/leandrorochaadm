...
\hypersetup{
  ...
  pdfkeywords={Flutter, Dart, Mobile, Clean Architecture, Riverpod, BLoC, ValueNotifier, ChangeNotifier, MVVM, Monorepo, Microapps, Testes, TDD, Firebase, Supabase, Claude Code, IA, Observabilidade, Monitoramento, Apps em produção, Squad, Scrum, Ágil, LiveKit, WebRTC, FaceTec, OCR},
  pdflang={pt-BR}
}
\usepackage{parskip}
...
\begin{tight}
  ...
  \item \lbl{Qualidade e observabilidade:} \textbf{Testes unitários e de widget (Mocktail)} | \textbf{TDD} | \textbf{monitoramento e investigação de incidentes em produção} (\textbf{Firebase Crashlytics}, Microsoft Clarity) | \textbf{CI/CD (GitHub Actions, Codemagic)} | \textbf{Git Flow} e \textbf{trunk-based} | code review
